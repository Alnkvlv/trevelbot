...
countries_info = {
    ...
    "Сербия": {
        "Важные правила и особенности": "Язык официальный — сербский (кириллица и латиница). В туристических местах часто говорят по‑английски. Небольшой набор фраз на сербском поможет.
...
Что нельзя: 
наркотики — строгие наказания; 
провоз некоторых товаров через границу ограничен (алкоголь, табак свыше норм, крупные суммы наличных — декларируйте).
...
Интересные факты: 
столетние монастыри, традиционная кухня с сильным влиянием Балкан/Османской/Центральной Европы. Белград — оживлённый культурный и ночной центр.",
        "Требуемые документы":"
}
