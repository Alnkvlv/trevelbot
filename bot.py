...
local_images = {
    ...
    "Сербия": {
        "Ćevapčići (чевaпчичи) — маленькие рубленые мясные колбаски (говядина/смешанное мясо), подаются с лепёшкой (lepinja), луком и каймаком/айваром.": os.path.join(BASE_DIR, "images", "Ćevapčići.jpg"),
        "Pljeskavica (плескавица) — большая мясная котлета/бургер по‑балкански; часто с сыром или луком": os.path.join(BASE_DIR, "images", "Pljeskavica.jpg"),
        "Burek — слойный пирог с начинкой (мясо, сыр, картофель); популярен на завтрак.": os.path.join(BASE_DIR, "images", "Burek.jpg")
    }
}
...
countries_info = {
    ...
    "Сербия": {
        ...
        "🗣 Язык официальный — сербский (кириллица и латиница). В туристических местах часто говорят по‑английски. Небольшой набор фраз на сербском поможет.\n"
        ...
        "✈️Билеты туда/обратно или подтверждение дальнейшей поездки (иногда спрашивают на границе).\n"
    ...
    "Популярные места для посещения": ["Калемегданская крепость — вид на слияние Савы и Дуная, музеи и парк.", "Скадарлия — старый богемный квартал с ресторанами и живой музыкой.", "Национальный парк Тара и Златибор."],
    "Национальная кухня": ["Ćevapčići (чевaпчичи) — маленькие рубленые мясные колбаски (говядина/смешанное мясо), подаются с лепёшкой (lepinja), луком и каймаком/айваром.", "Pljeskavica (плескавица) — большая мясная котлета/бургер по‑балкански; часто с сыром или луком.", "Burek — слойный пирог с начинкой (мясо, сыр, картофель); популярен на завтрак."]
    }
}
